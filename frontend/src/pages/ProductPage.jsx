...
export default function ProductPage() {
  ...
  // Прокрутка каруселі "Схожі товари"
  ...
  if (loading) {
    return (
      ...
      >
        ...
        <div
          style={{ maxWidth: "1440px", margin: "0 auto", padding: "16px 40px" }}
        >
          <div
            style={{
              display: "flex",
  ...
  const currentPrice = Number(product.price) || 209.9;
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="#1e40af">
                  <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                </svg>
                <span style={{ fontWeight: "600" }}>
                  {product.rating || "3.4"}
                </span>{" "}
                <span style={{ color: "#666" }}>- Увійдіть, щоб оцінити</span>
              </div>
              <div
                style={{
                  display: "flex",
            ...
            >
              ...
              >
                {product.description ||
                  "Інформація про склад відсутня. Натуральний продукт високої якості без додавання консервантів."}
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                <div>
                  ...
                  <div style={{ fontWeight: "700", fontSize: "14px" }}>
                    {product.nutrition?.energy || "153/641"}
                  </div>
                </div>
                <div>
                  <div
