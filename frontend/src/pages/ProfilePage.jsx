...
export default function ProfilePage() {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        const savedUser = JSON.parse(localStorage.getItem("silpo-user") || "{}");
        localStorage.setItem("silpo-user", JSON.stringify({ ...savedUser, avatar: base64String }));
      };
  ...
  const handleRemoveAvatar = (e) => {
    ...
    const savedUser = JSON.parse(localStorage.getItem("silpo-user") || "{}");
    localStorage.setItem("silpo-user", JSON.stringify({ ...savedUser, avatar: "" }));
  };

  const fullName = [user.lastName, user.firstName, user.middleName].filter(Boolean).join(" ") || user.firstName;
    ...
    <div className="profile-container">
      ...
      <aside className="profile-sidebar">
        <div className="sidebar-menu">
          ...
          <button className="menu-item logout-button" onClick={handleLogout}>
            <img src="/images/figma/icons/log-out.svg" alt="" width="18" height="18" /> Вийти
          </button>
        </div>
      </aside>
      ...
      <main className="profile-main">
        <div className="profile-main-inner">
          ...
          {/* =========================================
              ЕКРАН 1: ГОЛОВНИЙ ДАШБОРД (4 КАРТКИ)
          ========================================= */}
                  ...
                  <div className="card-body">
                    <div className="data-row">
                      <span style={{display: "flex", alignItems: "center", gap: "6px"}}>
                        <img src="/images/figma/icons/user-small.svg" alt="" width="14" height="14" /> Ім'я
                      </span>
                      <strong>{user.firstName}</strong>
                    </div>
                    <div className="data-row">
                      <span style={{display: "flex", alignItems: "center", gap: "6px"}}>
                        <img src="/images/figma/icons/mail.svg" alt="" width="14" height="14" /> Email
                      </span>
                      <strong>{user.email}</strong>
                    </div>
                    <div className="data-row">
                      <span style={{display: "flex", alignItems: "center", gap: "6px"}}>
                        <img src="/images/figma/icons/phone.svg" alt="" width="14" height="14" /> Телефон
                      </span>
                  ...
                  <div className="card-body">
                    <div className="data-row address-row">
                      <span className="address-type-label">
                        <img src="/images/figma/icons/home-small.svg" alt="" width="14" height="14" /> Основна адреса
                      </span>
                      <strong className="address-text-value">вул. Таращанська, 161, Біла Церква, 09100</strong>
                    </div>
                  </div>
                  <div className="card-footer-container">
                    <button className="card-footer-link">Переглянути всі адреси <span>❯</span></button>
                ...
                <div className="info-card">
                  ...
                  <div className="card-body purchase-list">
                    <div className="purchase-item">
                      ...
                      <span className="purchase-price">1 238 ₴ <span>❯</span></span>
                    </div>
                  </div>
                  <button className="card-footer-link">Переглянути всі замовлення <span>❯</span></button>
                </div>
                ...
                <div className="info-card">
                  ...
                  <div className="card-body security-body">
                    <button className="security-row-action">
                      <span style={{display: "flex", alignItems: "center", gap: "6px"}}>Змінити пароль</span><span>❯</span>
                    </button>
                    <div className="security-row-status">
                      <span style={{display: "flex", alignItems: "center", gap: "6px"}}>Підтвердження email</span>
                      <span className="status-verified">Підтверджено ✓</span>
                    </div>
                  </div>
                  <button className="card-footer-link">Налаштування безпеки <span>❯</span></button>
                </div>
          ...
          {activeView === "myData" && (
            <div className="details-view">
              ...
              {/* АВАТАР ІЗ КНОПКОЮ ДОДАВАННЯ/ВИДАЛЕННЯ */}
              <div className="details-avatar-container">
                ...
                >
                  {user.avatar ? (
                    ...
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                  )}
              ...
              <div className="details-cards-wrapper">
                  ...
                  <div className="details-list">
                    ...
                    <div className="details-list-item" onClick={() => openEdit("editBirthDate")}>
                      <div className="details-item-content">
                        ...
                        {user.birthDate ? (
                          <strong className="details-value">{user.birthDate}</strong>
                        ) : null}
                      </div>
                      <span className={`details-action ${user.birthDate ? 'arrow' : ''}`}>
                        {user.birthDate ? '❯' : '+'}
                      </span>
                    </div>
                ...
                <div className="details-block">
                  <div className="details-block-header">
                    <div className="details-icon-solid">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                    </div>
                    <h3>Контакти</h3>
                  </div>
                  ...
                  <div className="details-list">
                    <div className="details-list-item" onClick={() => openEdit("editPhone")}>
                      ...
                      <span className="details-action">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8E1616" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                      </span>
                    </div>
          ...
          {activeView === "editName" && (
            <div className="edit-form-view">
              <button className="back-link-btn" onClick={() => setActiveView("myData")}>❮ Назад</button>
              <h2 className="edit-form-title">Прізвище, ім’я</h2>
              <div className="edit-form-inputs">
                <input type="text" name="lastName" placeholder="Прізвище" value={editData.lastName || ""} onChange={handleEditChange} className="edit-input-field" />
                <input type="text" name="firstName" placeholder="Ім'я" value={editData.firstName || ""} onChange={handleEditChange} className="edit-input-field" />
                <input type="text" name="middleName" placeholder="По батькові" value={editData.middleName || ""} onChange={handleEditChange} className="edit-input-field" />
              </div>
              <div className="edit-form-buttons">
                <button className="btn-cancel" onClick={() => setActiveView("myData")}>Скасувати</button>
                <button className="btn-save" onClick={handleSaveDetails}>Зберегти</button>
              </div>
            </div>
          )}
          ...
          {activeView === "editBirthDate" && (
            <div className="edit-form-view">
              ...
              <div className="edit-form-inputs">
                <input type="text" name="birthDate" placeholder="дд.мм.рррр" value={editData.birthDate || ""} onChange={handleEditChange} className="edit-input-field" />
              </div>
              <div className="edit-form-buttons">
                <button className="btn-cancel" onClick={() => setActiveView("myData")}>Скасувати</button>
                <button className="btn-save" onClick={handleSaveDetails}>Зберегти</button>
          ...
          {activeView === "editGender" && (
            <div className="edit-form-view">
              ...
              <div className="edit-form-inputs">
                <select name="gender" value={editData.gender || "Не вказано"} onChange={handleEditChange} className="edit-input-field">
          ...
          {activeView === "editPhone" && (
            <div className="edit-form-view">
              ...
              <div className="edit-form-inputs">
                <input type="tel" name="phone" placeholder="+380..." value={editData.phone || ""} onChange={handleEditChange} className="edit-input-field" />
              </div>
              <div className="edit-form-buttons">
                <button className="btn-cancel" onClick={() => setActiveView("myData")}>Скасувати</button>
                <button className="btn-save" onClick={handleSaveDetails}>Зберегти</button>
          ...
          {activeView === "editEmail" && (
            <div className="edit-form-view">
              ...
              <div className="edit-form-inputs">
                <input type="email" name="email" placeholder="example@gmail.com" value={editData.email || ""} onChange={handleEditChange} className="edit-input-field" />
              </div>
              <div className="edit-form-buttons">
                <button className="btn-cancel" onClick={() => setActiveView("myData")}>Скасувати</button>
                <button className="btn-save" onClick={handleSaveDetails}>Зберегти</button>
