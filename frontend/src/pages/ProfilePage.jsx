...
export default function ProfilePage() {
  ...
  const user = {
    ...
    email: savedUser?.user?.email || savedUser?.email || "aleksandrar.6478392@gmail.com",
      ...
      <div className="profile-shell">
        <aside className="profile-sidebar">
          <nav className="profile-menu">
            <button className="profile-menu__item profile-menu__item--active">⌂ Профіль</button>
        ...
        <main className="profile-main">
          ...
          <div className="profile-grid">
            <section className="profile-block">
              <h3>♡ Мої дані</h3>
              <p className="profile-block__hint">Особиста інформація та контакти</p>
              ...
              <button className="profile-link-button">Переглянути всі дані ›</button>
            </section>
            ...
            <section className="profile-block">
              ...
              <div className="profile-row profile-row--address">
                ...
                <b>вул. Таращанська, 161,<br />Біла Церква, 09100</b>
              </div>

              <button className="profile-outline-button">＋ Додати адресу</button>
            </section>
            ...
            <section className="profile-block">
              ...
              <button className="profile-link-button">Переглянути всі замовлення ›</button>
            </section>

            <section className="profile-block">
              <h3>♢ Безпека</h3>
              <p className="profile-block__hint">Налаштування безпеки облікового запису</p>
              ...
              <button className="profile-link-button">Налаштування безпеки ›</button>
            </section>
          </div>
          ...
          <section className="profile-promo">
            ...
            <div>
              ...
              <p>Слідкуйте за акціями, отримуйте персональні пропозиції та замовляйте разом з нами!</p>
            </div>
