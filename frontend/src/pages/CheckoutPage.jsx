              ...
              >
                ...
                {form.paymentMethod === "card" && (
                  ...
                  >
                    ...
                    >
                      💳 Оплата через Stripe (тестовий режим). Для перевірки
                      введіть номер картки <strong>4242 4242 4242 4242</strong>,
                      будь-яку майбутню дату та будь-який CVC.
                    </p>
                  </div>
                )}
              </div>
